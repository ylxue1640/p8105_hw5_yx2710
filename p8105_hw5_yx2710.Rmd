...
As the value of μ increases, the proportion of rejecting null hypothesis increases which means the power increases. As a result, we can conclude that as the effect size increases, the power also increases.
